...
if __name__ == "__main__":
    ...
    print(f"spark-class org.apache.spark.deploy.master.Master --host {get_windows_ip()} --port 7077")
    print(f"spark-class org.apache.spark.deploy.worker.Worker spark://{get_windows_ip()}:7077")
    print(f"start-dfs.sh")
    print(f"hdfs://{get_wsl_ip()}:9000")
    print("-" * 30)